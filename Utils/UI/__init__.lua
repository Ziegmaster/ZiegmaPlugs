DeusdictumDirectory = UtilsDirectory .. ".UI.Deusdictum";

import (DeusdictumDirectory);
import (UtilsDirectory .. ".UI.ComboBox");
import (UtilsDirectory .. ".UI.Slider");
import (UtilsDirectory .. ".UI.ShortcutButton");
...
dropDownArrowDisabled = Turbine.UI.Graphic(string.gsub(UtilsDirectory, "%.", "/") .. "/UI/Resources/dropdown_arrow_closed_ghosted.tga");
