...
Framework.UI.Controls.DeltaButtonWindow = class( Turbine.UI.Window );
...
function Framework.UI.Controls.DeltaButtonWindow:Constructor( tResources, bfZoneTest, ctlAttachTo )
...
function Framework.UI.Controls.DeltaButtonWindow:IsEnabled( )
	return self.bEnabled;
end

function Framework.UI.Controls.DeltaButtonWindow:IsMouseMoving( )
	return self.bMouseMoving;
end

function Framework.UI.Controls.DeltaButtonWindow:SetMouseMoving( bValue, args )
...
function Framework.UI.Controls.DeltaButtonWindow:SetEnabled( bValue )
...
function Framework.UI.Controls.DeltaButtonWindow:SetOffset( oX, oY )
	self.offsetX, self.offsetY = oX, oY;
end

function Framework.UI.Controls.DeltaButtonWindow:RecalculatePosition( )
	local X, Y;
...
function Framework.UI.Controls.DeltaButtonWindow:RefreshImage( )
