...
Framework.UI.Controls.DeltaButtonControl = class( Turbine.UI.Control );
...
function Framework.UI.Controls.DeltaButtonControl:Constructor( tResources, bfZoneTest, ctlAttachTo )
...
function Framework.UI.Controls.DeltaButtonControl:IsEnabled( )
	return self.bEnabled;
end

function Framework.UI.Controls.DeltaButtonControl:IsMouseMoving( )
	return self.bMouseMoving;
end

function Framework.UI.Controls.DeltaButtonControl:SetMouseMoving( bValue, args )
...
function Framework.UI.Controls.DeltaButtonControl:SetEnabled( bValue )
...
function Framework.UI.Controls.DeltaButtonControl:RefreshImage( )
